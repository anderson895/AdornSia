...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full mx-auto justify-center">
    ...
    <a href="product.php">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full h-full overflow-y-auto" id="bestSellingProducts">
            <!-- Content goes here -->
        </div>
    </a>
    ...
    <!-- New Products Card -->
    <a href="product.php">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full h-full overflow-y-auto" id="NewProduct">
            <!-- Content goes here -->
        </div>
    </a>
    ...
    <a href="product.php">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full h-full overflow-y-auto" id="stock_status">
            <!-- Content goes here -->
        </div>
    </a>
    ...
    <a href="customer.php">
        <div class="bg-white p-6 rounded-lg shadow-lg w-full h-full overflow-y-auto" id="top_customer">
            <!-- Content goes here -->
        </div>
    </a>
</div>
