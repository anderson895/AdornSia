...
<div class="max-w-4xl mx-auto p-8 bg-white shadow-xl rounded-lg mt-8">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div>
      ...
      <input type="text" value="<?=$user_fullname?>" class="mt-2 bg-gray-100 p-4 w-full border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition ease-in-out">
      ...
      <div class="flex items-center border-b border-gray-300 pb-2">
        <input type="email" value="<?=$user_email?>" class="mt-2 p-4 w-full bg-gray-100 border-0 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition ease-in-out">
      </div>
      
      <label class="block text-sm font-medium text-gray-700 mt-6">Phone Number</label>
      <div class="flex items-center border-b border-gray-300 pb-2">
        <input type="text" value="<?=$user_phone?>" class="mt-2 p-4 w-full bg-gray-100 border-0 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition ease-in-out" >
      </div>
    </div>
    ...
    <div class="flex flex-col justify-between">
     ...
     class="w-32 h-32 rounded-full mx-auto object-cover">
        ...
        <label for="profile-image" class="mt-2 inline-block text-blue-500 hover:text-blue-700 transition ease-in-out cursor-pointer">Upload Image</label>
      </div>
    </div>
  </div>

  <div class="mt-8 flex justify-end">
    <button class="bg-orange-500 text-white py-3 px-8 rounded-lg hover:bg-orange-600 transition ease-in-out text-lg font-medium">Save</button>
  </div>
</div>
