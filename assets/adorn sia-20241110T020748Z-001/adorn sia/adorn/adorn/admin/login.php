...
<head>
    ...
    <style>
        ...
        .remember-me {
            ...
            /* Space between checkbox and forgot password link */
            margin-bottom: 30px;
        }
        ...
        <div class="login-form">
            ...
            <form action="login.php" method="post">
                <div class="username-container">
                    <input type="text" id="username" name="adminUser" placeholder="Username" required value="<?php echo $userInput; ?>">
                </div>
                <div class="password-container">
                    <input type="password" id="password" name="adminPass" placeholder="Password" required>
            ...
            <p class="message" id="admin-loginMessage" style="color: red;"><?php echo $errorMessage; ?></p>
            <?php endif; ?>
