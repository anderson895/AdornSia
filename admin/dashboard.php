...
<div class="mt-8 px-4">
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 w-full">
        <div class="bg-white p-6 rounded-lg shadow-lg" id="bestSellingProducts"></div>
        <div class="bg-white p-6 rounded-lg shadow-lg" id="NewProduct"></div>
        <div class="bg-white p-6 rounded-lg shadow-lg" id="stock_status"></div>
    </div>
</div>

<!-- Sales Performance Cards -->
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8 w-full">
